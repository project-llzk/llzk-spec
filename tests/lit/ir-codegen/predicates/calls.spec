...
// CHECK-NEXT:      }
// CHECK-NEXT:    }
// CHECK-NEXT:    function.def @not(%[[VAL_6:[0-9a-zA-Z_\.]+]]: i1) -> i1 attributes {function.allow_non_native_field_ops} {
// CHECK-NEXT:      %[[VAL_7:[0-9a-zA-Z_\.]+]] = bool.not %[[VAL_6]] : i1
// CHECK-NEXT:      function.return %[[VAL_7]] : i1
// CHECK-NEXT:    }
// CHECK-NEXT:    function.def @identity(%[[VAL_8:[0-9a-zA-Z_\.]+]]: i1) -> i1 attributes {function.allow_non_native_field_ops} {
// CHECK-NEXT:      %[[VAL_9:[0-9a-zA-Z_\.]+]] = function.call @not(%[[VAL_8]]) : (i1) -> i1
// CHECK-NEXT:      %[[VAL_10:[0-9a-zA-Z_\.]+]] = function.call @not(%[[VAL_9]]) : (i1) -> i1
// CHECK-NEXT:      function.return %[[VAL_10]] : i1
// CHECK-NEXT:    }
// CHECK-NEXT:    function.def @recursive(%[[VAL_11:[0-9a-zA-Z_\.]+]]: i1) -> i1 attributes {function.allow_non_native_field_ops} {
// CHECK-NEXT:      %[[VAL_12:[0-9a-zA-Z_\.]+]] = scf.if %[[VAL_11]] -> (i1) {
// CHECK-NEXT:        %[[VAL_13:[0-9a-zA-Z_\.]+]] = arith.constant true
// CHECK-NEXT:        scf.yield %[[VAL_13]] : i1
// CHECK-NEXT:      } else {
// CHECK-NEXT:        %[[VAL_14:[0-9a-zA-Z_\.]+]] = arith.constant true
// CHECK-NEXT:        %[[VAL_15:[0-9a-zA-Z_\.]+]] = function.call @recursive(%[[VAL_14]]) : (i1) -> i1
// CHECK-NEXT:        scf.yield %[[VAL_15]] : i1
// CHECK-NEXT:      }
